	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[TOR-BARKI-CP] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					print(" \033[1;33m[TOR-BARKI-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[TOR-BARKI-CP] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[TOR-BARKI-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[TOR-BARKI-CP] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[TOR-BARKI-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[TOR-BARKI-CP] "+uid+" | "+pass5+"\033[0;97m")
